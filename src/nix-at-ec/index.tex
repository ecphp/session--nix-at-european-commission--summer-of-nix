...
\begin{frame}
  ...
  \note<2>{
    The strategy led to the creation of a dedicated team - the
...
\begin{frame}
  ...
  \note<1>{
    ...
    Examples include Wireguard, TOR, F-Droid, OpenPGP, and Matrix, Cryptpad, Replicant, LIBRE SOC and RISC V SOC.
  }
  \note<2>{
    European Commission (Connect) has partnerships with NLnet and the NixOS Foundation.
  }
  \note<3>{
  ...
  \note<5>{
    ...
    I will begin to give some context, and the reasons why it is used.
